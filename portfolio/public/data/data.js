...
export const projects = [
  {
    ...
    description: "API that integrates the RakNet network library with the Havok physics engine to simulate server and client networking, visualize, and record bandwidth statistics.",
  ...
  },
  {
    ...
    description:"A study that presents the development of a gene visualization tool called input generated gene browser, or IGGB, which aims to provide a user-friendly gene browser.",
...
export const workexp = [
  ...
  },
  {
    ...
    location: "Stockholm, Sweden",
    workedAs: "Freelance",
    description: "Fullstack - Designed and created a webpage made with php, html, css and sql.",
